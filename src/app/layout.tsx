...
// Components & Providers
// Note: We removed the broken '@/components/ui/toaster' and kept Sonner for all notifications.
import { Toaster as Sonner } from "@/components/ui/sonner";
import { TooltipProvider } from "@/components/ui/tooltip";
import QueryProvider from "@/components/providers/QueryProvider";
import Navigation from "@/components/Navigation";
...
/** * METADATA API 
 * Updated with your actual GitHub username to ensure SEO and social sharing works.
 */
export const metadata: Metadata = {
  title: {
    default: "FitZone Gym | Transform Your Body & Life",
    template: "%s | FitZone Gym",
  },
  description: "Premium fitness center offering expert personal training, group classes, and state-of-the-art equipment. Join FitZone Gym today.",
  authors: [{ name: "MystryMind Innovations" }],
  metadataBase: new URL("https://BallaJaideep.github.io/fitZone-gym"),
  openGraph: {
    title: "FitZone Gym - Premium Fitness Center",
    description: "Transform your body with expert trainers and world-class facilities",
    url: "https://BallaJaideep.github.io/fitZone-gym",
    siteName: "FitZone Gym",
    type: "website",
    images: [
      {
  ...
  twitter: {
    card: "summary_large_image",
    title: "FitZone Gym",
    description: "Your journey to peak fitness starts here.",
      ...
      >
        <QueryProvider>
          <TooltipProvider delayDuration={0}>
            ...
            {/* Global Notifications (Sonner is used instead of the broken Toast component) */}
            <Sonner position="top-center" richColors closeButton />
          </TooltipProvider>
        </QueryProvider>
      </body>
