...
export default function NotFound() {
  ...
  useEffect(() => {
    // Logging the error for your analytics/debugging
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4 text-center">
      ...
      <div className="mb-8 animate-scale-in">
        <div className="relative inline-block">
          ...
          <Dumbbell size={80} className="text-primary relative rotate-12" />
        </div>
      </div>
      ...
      <div className="mt-12 flex flex-col sm:flex-row gap-4 animate-slide-up">
        <Link href="/">
          <Button variant="hero" size="lg" className="px-8 font-black uppercase tracking-widest">
      ...
      <div className="absolute bottom-10 opacity-20 flex items-center gap-2">
        <span className="font-black uppercase tracking-[0.3em] text-xs">FitZone Gym</span>
      </div>
    </div>
  );
}